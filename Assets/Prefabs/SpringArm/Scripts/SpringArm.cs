...
public class SpringArm : MonoBehaviour
{
    ...
    */}
    ...
    private void Rotate()
    {
        ...
        {
            // Increment yaw by Mouse X input
            yaw += cameraInput.x * gamepadSensitivity * Time.deltaTime;
            // Decrement pitch by Mouse Y input
            pitch -= cameraInput.y * gamepadSensitivity * Time.deltaTime;
        }else { 
        // Increment yaw by Mouse X input
        yaw += cameraInput.x * mouseSensitivity * Time.deltaTime;
        // Decrement pitch by Mouse Y input
        pitch -= cameraInput.y * mouseSensitivity * Time.deltaTime;
    ...
    public void GetCameraValues(InputAction.CallbackContext context)
    {
        ...
        //XInputControllerWindows:/ XInputControllerWindows
        //if(Gamepad.current.)
